package br.matosit.product_service.adapters.in.rest.handlers;
...
import br.matosit.product_service.adapters.in.rest.responses.ErrorResponse;
...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ErrorResponse> handleCustomerNotFound(ProductNotFoundException ex) {
    ErrorResponse response = ErrorResponse.of(ex.getCode(), ex.getMessage());
  ...
  public ResponseEntity<ErrorResponse> handleGenericException(Exception ex) {
    ErrorResponse response =
        ErrorResponse.of("INTERNAL-001", "Ocorreu um erro interno no servidor");
